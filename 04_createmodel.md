...
[**前のステップ**](./03_preparedataload.md) で、アプリケーションのプロジェクトを作成し、データセットを利用できるようになりました。
...
[前のステップ](./03_preparedataload.md) でアプリケーションのひな形が作成できたので、いよいよコーディングを始めます。
...
以上で、学習モデルを作成できました。  
[次のステップ](./05_predictmodel.md) では、学習済みモデルを使って、予測モデルを作成します。さらにサービスとしてクライアントから利用できるようにします。
